...
<head> 
<title>在线代码高亮(纯代码版)--www.xiaofengsky.com</title>
...
<div id="footer">
	<p class="wrapper">
		在线代码高亮(纯代码版) 由 <a href="http://www.baidu.com/" target="_blank">百度</a> 提供服务器  <a href="/">普通版</a> <a href="my.php">纯代码版</a>  <script type="text/javascript" src="http://tajs.qq.com/stats?sId=270473446" charset="UTF-8"></script>
	</p>
</div>
</body>
</html>